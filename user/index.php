...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container px-4 px-lg-5">
            ...
            ?>
            <img style="margin-top:50px; width:50%; height:400px; border-radius:10px; margin-left:200px;padding-left:200px;" src="<?=$files[$file]?>">
            <!-- Call to Action-->
            <div class="card text-white bg-secondary my-5 py-4 text-center">
                <div class="card-body"><p class="text-white m-0" style="font-size:30px;">Produk Terbaru</p></div>
            </div>
            <!-- Content Row-->
            <div class="row gx-4 gx-lg-5">
                <?php 
                    $produk = mysqli_query($conn, "select * from barang order by id_produk desc limit 6");
